...
// Simplified hierarchy: Department → Category
const SIMPLIFIED_HIERARCHY = {
  'Kids': ['Upper', 'Lower', 'Sets', 'Denim'],
  'Ladies': ['Upper', 'Lower', 'Sets', 'Denim'],
  'Mens': ['Upper', 'Lower', 'Sets', 'Denim']
};
      ...
      <div style={{ display: 'grid', gap: 16 }}>
        ...
        {selectedDepartment && (
          <div>
            ...
            <Select
              placeholder="Select category (Tops, Bottoms, etc.)"
