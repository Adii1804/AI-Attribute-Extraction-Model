...
const isBottomCategory = (value?: string) => {
  ...
  return v.includes('lower') || v.includes('denim') || v.includes('bottom') || v.includes('jean') || v.includes('pant') || v.includes('trouser') || v.includes('short') || v.includes('skirt');
};

const isTopCategory = (value?: string) => {
  if (!value) return false;
  const v = value.toLowerCase();
  return v.includes('upper') || v.includes('top') || v.includes('shirt') || v.includes('t-shirt') || v.includes('outerwear') || v.includes('lingerie') || v.includes('suit') || v.includes('activewear');
};

const isFullBodyCategory = (value?: string) => {
  if (!value) return false;
  const v = value.toLowerCase();
  return v.includes('sets') || v === 'sets' || v.includes('dress') || v.includes('set') || v.includes('co-ord') || v.includes('coord') || v.includes('romper') || v.includes('jumpsuit') || v.includes('overall');
};
                ...
                <Card className="step-card" style={{ 
                  ...
                  <div style={{ textAlign: 'center', marginBottom: 16 }}>
                    ...
                    <Text type="secondary" style={{ fontSize: '13px' }}>
                      Choose Division → Category (Upper/Lower/Sets/Denim)
                    </Text>
                  </div>
